...
if system == "Windows":
    ...
    #GS (changed folder to utility ... project folder accessible from all Resolve pages)
    resolve_script_dir = user_home / "AppData" / "Roaming" / "Blackmagic Design" / "DaVinci Resolve" / "Support" / "Fusion" / "Scripts" / "Utility"
